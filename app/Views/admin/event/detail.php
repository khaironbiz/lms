        ...
        <table class="table table-sm table-striped">
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-default<?= $k['has_kelas'] ?>">
                        <i class="fa fa-edit"></i> Edit
                    </button>
                    <?= form_open(base_url('admin/kelas/update/'.$berita['has_berita']));
                        echo csrf_field();
                    ?>
                    <div class="modal fade" id="modal-default<?= $k['has_kelas'] ?>">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">Tambah Kelas</h4>
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-2">Kelas</label>
                                        <div class="col-10">
                                            <input type="text" name="nama_kelas" class="form-control form-control-sm" placeholder="Nama Kegiatan" value="<?= $k['nama_kelas'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2">Tanggal Mulai</label>
                                        <div class="col-md-4">
                                            <input type="text" name="tanggal_mulai" class="form-control form-control-sm tanggal" value="<?= $k['tanggal_mulai']?>" required>
                                        </div>
                                        <label class="col-2">Tanggal Selesai</label>
                                        <div class="col-md-4">
                                            <input type="text" name="tanggal_selesai" class="form-control form-control-sm tanggal" value="<?= set_value('tanggal_selesai') ?>" required>
